...
for batch_name in batch_ids.keys():
    ...
    if batch.status == "completed":
        ...
        chart_type, ques_type, gen_type = batch_name.split("_")
        os.makedirs(f"./GPT_final_output/{chart_type}", exist_ok=True)
        content.write_to_file(f"./GPT_final_output/{chart_type}/{ques_type}_{gen_type}.jsonl")